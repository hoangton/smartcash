.. meta::
   :description: Guides to secure paper wallets for SmartCash cryptocurrency
   :keywords: smartcash, paper, wallet, encryption

.. _smartcash-paper-wallet:
...
SmartCash, but care must be taken not to lose the private key, since there is
...
A SmartCash paper wallet can be generated in several ways.

- Using the generator at https://paperwallet.smartcash.cc/
...
guide will use https://paperwallet.smartcash.cc/ as an example. The websites
...
Go to https://paperwallet.smartcash.cc/ in your web browser (or open index.html if
you downloaded the wallet generator). Select your language and choose
SmartCash as the currency if necessary. The following screen will appear:

.. figure:: img/paper-start.png
   :width: 400px

   The SmartCash Paper Wallet Generator at paperwallet.smartcash.cc
...
.. figure:: img/paper-randomness.png
   ...
   Generating randomness for the SmartCash Paper Wallet Generator

.. figure:: img/paper-addresses.png
   :width: 400px

   A SmartCash address and private key generated using SmartCash Paper Wallet 
   Generator
...
the page without somehow recording the smartcash address and private key, all
...
know how to do this. For this example, 0.05 SmartCash (minus transaction fee)
...
.. figure:: img/paper-block.png
   ...
   Viewing the balance of the paper wallet using the SmartCash Block Explorer at explorer.smartcash.cc
...
the wallet into another SmartCash wallet that is connected to the internet.
We will use the SmartCash Core Wallet in this example, although SmartCash Electrum
and mobile wallets are also supported. Open SmartCash Core Wallet, click
...
.. figure:: img/paper-import.png
   ...
   SmartCash Core Wallet importing a private key
